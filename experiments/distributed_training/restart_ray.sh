...
ssh $RAY_WORKER_IP "source ~/anaconda3/bin/activate exoflow-dev; PYTHONPATH=~/efs/exp1 ray start --address=$RAY_HEAD_IP:6379 --disable-usage-stats --object-manager-port=8076 --resources='{\"machine\": 1, \"tag:data\": 1}' --storage=s3://siyuan-workflow/exp1 --num-cpus 32"
